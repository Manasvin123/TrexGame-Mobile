...
function obstacles(){
  ...
  if(frameCount % 60 === 0){
  obstacle=createSprite(width/2,height-100, 50, 50)
...
function setup() {
  ...
  invisibleGround = createSprite(width/2,height-80,5000, 20);
  ...
  gameOver = createSprite (width/2,height/2, 400, 10)
  gameOver.addImage("gameOver", gameOverimage);
  gameOver.scale=0.6
  
  
  restart = createSprite (width/2,(height/2)+40, 400, 10)
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    cloud = createSprite(width/2,height-100,40,10);
